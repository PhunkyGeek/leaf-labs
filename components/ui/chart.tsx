...
/** Minimal, version-agnostic tooltip content props (typed safely without relying on deep Recharts types). */
type ChartTooltipContentProps = React.ComponentProps<'div'> & {
  ...
  labelFormatter?: (label: string | number | undefined, payload?: ChartTooltipContentProps['payload']) => React.ReactNode;
  formatter?: (
    value: number | string,
    name: any,
